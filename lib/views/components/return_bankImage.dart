...
import 'package:gt2022/models/transaction.dart';

Widget getBankImageAvatar(Transaction transaction,
  ...
  if (transaction.amount < 0) {
    ...
    return ClipRRect(
        ...
        child:
            Image.asset(image, fit: BoxFit.fill, height: height, width: width));
  } else {
    ...
    return ClipRRect(
        ...
        child: Image.asset(image,
            fit: BoxFit.fill, height: height, width: height));
  }
}
